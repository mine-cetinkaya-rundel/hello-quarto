...
**Julie:** Thanks Mine. We've seen already how much Quarto enables and now I want to push it a bit further. What if we could reimagine open science as part of the climate movement. We know what this R community is capable of, what if
:::
...
::: notes
Because **we are in a climate emergency**. We must rapidly, radically reshape society. Let's think about this with 3 user groups if you will

people working direct w climate - hard and stuck. Openscapes R/open source - stuck, Posit 100 yrs extensible beyond

Every solution, every solver. Across all facets and geographies, skills, expertise Dial up inclusion and culture change and welcome

We're talking about Openscapes has been working in this first category - seeing how powerful this kind of reimagining is.
...
::: notes
We're talking about a **profound culture shift** that involves real deliberate work on the tech and culture side

Let's focus on the culture side: We can **build inclusion into our daily work**. Let's think about your team and collagues because I bet they're not different from the teams we mentor
...
All have diff projects diff deliverables, but they are a team. cross all projects
...
These are examples: Using quarto for culture change - no code. friendly - 
:::
...
transition: throughtout talk, focus on quarto enabling culture. 
...
::: notes
We can all enable reimagining at levels. We can all play our part We can do this in our daily work, with teams, scale it beyond. We invite you to reimagine with us - And we cannot, we must not go it alone.
:::
