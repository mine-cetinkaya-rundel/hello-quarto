...
##  {#pass-to-collaborate data-menu-title="Pass to collaborate"  background-image="images/horst-quarto-meteor-L-to-R.png" aria-label="Quarto logo depicted as a meteor against a dark background with a tail comprised of bright stars, going from left to right."}
