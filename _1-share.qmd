...
I am an educator -- a developer educator at RStudio and a professor at Duke where I teach and conduct research.
...
![](images/horst_quarto_ball.png){fig-align="center" width="50%"}
...
::: illustration
**Illustration:** Add Allison's illustration of diagram from https://mine-cetinkaya-rundel.github.io/hello-quarto-sdssg/#/running-code
:::
...
For example, here are common things I produce \<\>a lesson in document form \<\>the same content in presentation form \<\>the same content embedded in a website, and you can see that all that needed to change is a few lines in the yaml.
This has helped me focus my time on content, and that, folks, is the dream!
:::
...
::: notes
Easily creating reproducible artifacts is great. 
But for the sharing story to be complete, the tool also needs to support easily _sharing_ those artifacts, like with a simple command like `quarto publish`, and hopefully soon a button RStudio that does the same thing.
