...
I am an educator -- a developer educator at RStudio and a professor at Duke where I also do research in addition to my teaching.
...
More often than not I'm thinking "web first" to ease open sharing and wider reach, but I also still live in the confines of traditional journal publishing and academia, which means I regularly need to create PDF documents as well.
...
In fact, I remember vividly the first time I've heard of knitr at useR 2012. Yihui Xie and JJ Allaire gave a keynote on reproducible authoring with knitr and it must have been no more than 3 slides into their talk that fired up my laptop and started to converting my teaching materials to use it while the keynote was still going on because it so clearly addressed a huge pain point for me of creating web-ready, reproducible documents that brought code and prose together. And by the end of that keynote I was already brainstorming ways of teaching it in my intro stats course to my students.

So, I'll call this keynote a success if a few of you are already firing up Quarto right now, instead of listening to me, to see what all the hype is about!
:::

## {#link-to-slides data-menu-title="Link to slides" .center background-image="images/horst_quarto_penguins_url.png"}

::: notes
But I hope you'll continue to listen with one ear and take in the beautiful illustrations by Allison Horst. And if you just want to sit back and enjoy the talk, feel free to cross your arms and I'll advance the slides for you.
:::
...
![](images/horst_quarto_ball.png){width="80%" fig-align="center"}
...
<>the same content embedded in a website, and you can see that all that needed to change is a few lines in the yaml.
...
Tooling that makes it easy to share what you do<br>
...
::: {.fragment .fade-up .large}
It's **useful** not just to you, but **to the world**<br>
as it facilitates open sharing of knowledge<br>
for learning and for reuse
:::

::: notes
It's easy to create and the next step is sharing and that's easy too
:::

##  {#pass-to-collaborate background-image="images/horst_quarto_meteor.png" aria-label="Quarto logo depicted as a meteor against a dark background with a tail comprised of bright stars."}
