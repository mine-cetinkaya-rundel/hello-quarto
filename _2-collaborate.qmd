...
We work with professional research groups in government and academia, and we help these teams modernize their workflows and shift culture with their teams and organization through open software and practices. Adyan Rios from NOAA Fisheries and she's described Openscapes as saying:
:::
...
::: borderbox
![](images/hackathon.png){width="80%" fig-align="center" fig-alt="Screenshot of Quarto site for a NASA hackathon learning event"}
:::
...
::: {.column width="50%"}
::: borderbox
![](images/cloud_workshop_agu.png){width="70%" fig-alt="Screenshot of Quarto site for a NASA workshop learning event"}
:::

::: borderbox
![](images/swot-ocean-workshop.png){width="70%" fig-alt="Screenshot of Quarto site for a NASA workshop learning event"}
:::
:::

::: {.column width="50%"}
::: borderbox
![](images/cookbook.png){fig-alt="Screenshot of Quarto site for a NASA Cloud Cookbook" width="70%"}
:::

::: borderbox
![](images/quarto_slides_steiker.png){width="70%" fig-alt="Screenshot of Quarto slides  a NASA conference talk"}
:::
:::
:::
