...
However, these data are stored by 12 different data centers around the US and researchers go to different data centers separately to download the data which is sometimes terrabytes to analyze it locally.
(This is a huge burden on every user)
...
This was intimidating to me.
This was the first proj I was a PI on, NASA as an org was intimdating, earth science remote sensing data is new I was unfamiliar with Earth science as a research domain, the types of satellite imagery data NASA works with, not to mention cloud infrastructure that is evolving rapidly.
