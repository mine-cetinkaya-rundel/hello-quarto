...
Mine and I have been using Quarto for the last year; she has been teaching and contributing to quarto it since its earliest days and Openscapes has been the first external users of Quarto.
...
So start using Quarto, and get involved by asking questions, or providing feedback, or even building extensions for it.
:::
...
If you would like to start your Quarto journey by picking up where we left off, go to this URL and scroll forward to see the next few slides where we share resources for learning as well as references for the works we presented today.
We won't be taking questions right now, but stop by the Open Source booth at \[FIND TIME\] to meet the Quarto development team and ask any questions!
\[TO DO: Need better phrasing\]
:::
