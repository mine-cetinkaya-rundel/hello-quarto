...
#  {#thank-you data-menu-title="Coda" background-image="images/horst-quarto-meteor.png"}

[[mine.quarto.pub/hello-quarto](https://mine.quarto.pub/hello-quarto)]{.custom-url-middle-dark}

::: notes
If you would like to start sharing, collaborating, teaching, and reimagining with Quarto by picking up where we left off, go to this URL and scroll forward to see the next few slides where we share resources for learning as well as references for the works we presented today.
