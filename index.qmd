...
::: aside
Julie: So excited to be here. I am a log-time and prolific user of RMarkdown, and Quarto and love how out-of-the box they are; I can use them for communicating about research, teaching, and collaborating using mostly the defaults. This as you'll see has been helping me push and blur the boundaries of environmental science, open source, and teaching. What I'll share today is work with Openscapes colleagues and builds from so many mentors: RLadies, etc
:::
...
## NASA Openscapes: streamlining teamwork with quarto
...
Streamlines teamwork: we came together from across silos, with different skills, comfort with coding, different coding language, different tech. Quarto let us work in one place, visualizing an end-goal, contributing with confidence.
:::
...
## 2a. Interoperability with tech

creating collections

::: illustration
**Image:** Screenshot of portion of `_quarto.yml`: .ipynbs and .qmds.
:::
