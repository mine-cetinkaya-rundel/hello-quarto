...
::: aside
Mine: As an educator, two things are of upmost importance for me about the tools I use to create my materials: reproducibility and ease of transition between output formats (like documents to slides to websites to books).
...
::: aside
Julie: 2.
language compatibility - using quarto to support researchers early - first dev is in python but not limited
:::
...
(creating new problems/solutions because quarto exists)- new ways of thinking that aren't standard practices.
Book websites to collaborate on?
Not really how we thought about things before
...
::: aside
Julie: we help teams collaborate, upskill, become resilient.
3 big things:
:::
