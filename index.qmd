...
-   Unifies: Rethink the things that evolved organically across RMarkdown for 10 years.
    "Mosaic" idea.
    Things that have been "unified" in quarto
...
In addition, many new features are available including extensions for cross-references, figure panels, callouts, advanced page layout, and more.
While it is a "new" system, it should also be noted that it is highly compatible with existing content: you can render most R Markdown documents and Jupyter notebooks unmodified with Quarto.
J.J.
will discuss the philosophy and design of the system, demonstrate its capabilities, and talk about future directions for development.
:::
...
It's beautiful.
Automatic beautiful TOC on the right side
...
Tracy: Intersection with open science an open source?
...
Personal story: Mine and I met at an rOpenSci event, the community has a lot to do with that, keep crossing paths, RLadies.
It motivates the open science convo or wraps it up/enables it.
Open science not just products - it's the process/collab.
Quarto enables both.
...
Prev examples are really exciting for coders.
Also important for folks who don't code or don't identify as coders.
...
(Revisit from useR) Not necessarily for existing/experienced users to change their ways but to create an opportunity for including others...
...
You've already seen bits and pieces of the visual editor.
it's not just a bag of tricks, it's an inviting environment/ more than the sum of its parts
:::
:::
